...
class Clients_model extends Crud_model {
    ...
    function get_client_overview_info($client_id) {
        ...
        $sql = "SELECT project_table.total_projects, proposal_table.total_proposals, subscription_table.total_subscriptions, estimate_table.total_estimates, order_table.total_orders
        FROM $clients_table
